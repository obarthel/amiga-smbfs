...
int smba_open(smba_server_t *s, char *name, size_t name_size, smba_file_t **file, int * error_ptr);
...
int smba_seek (smba_file_t *f, long offset, long mode, off_t * new_position_ptr, int * error_ptr);
...
int smba_setattr(smba_file_t *f, smba_stat_t *data, int * error_ptr);
...
int smba_start(char *service, char *opt_workgroup, char *opt_username, char *opt_password, char *opt_clientname, char *opt_servername, int opt_cachesize, int opt_max_transmit, int opt_timeout, int opt_raw_smb, int opt_write_behind, int opt_prefer_write_raw, int opt_disable_write_raw, int opt_disable_read_raw, int * error_ptr, int * smb_error_class_ptr, int * smb_error_ptr, smba_server_t **result);
